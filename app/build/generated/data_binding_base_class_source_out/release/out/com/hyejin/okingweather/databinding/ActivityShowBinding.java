...
public final class ActivityShowBinding implements ViewBinding {
  ...
  private ActivityShowBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout mainframe) {
  ...
  public static ActivityShowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityShowBinding((ConstraintLayout) rootView, mainframe);
    }
